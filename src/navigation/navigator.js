...
export default {
    ...
    showModal(targetScreen, passProps, animation) {
      passProps = passProps ? passProps : {}
      animation = animation ? modalAnimations[animation] : modalAnimations.nothing
...
const modalAnimations = {
  left : {
    showModal : Animations.leftIn.content,
    dismissModal : Animations.leftOut.content
  },
  right : {
    showModal : Animations.rightIn.content,
    dismissModal : Animations.rightOut.content
  },
  top : {
    showModal : Animations.topIn.content,
    dismissModal : Animations.topOut.content
  },
  bottom : {
    showModal : Animations.bottomIn.content,
    dismissModal : Animations.bottomOut.content
  },
  fade : {
    showModal : Animations.fadeIn.content,
    dismissModal : Animations.fadeOut.content
  },
  nothing : {
